...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r162 = ctx.$implicit; return step_r162.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r168); const ctx_r167 = ɵngcc0.ɵɵnextContext(); return ctx_r167._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(2, MatHorizontalStepper_ng_container_1_div_2_Template, 1, 0, "div", 5);
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const step_r162 = ctx.$implicit;
    const i_r163 = ctx.index;
    const isLast_r164 = ctx.last;
    const ctx_r160 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r160._getFocusIndex() === i_r163 ? 0 : 0 - 1)("id", ctx_r160._getStepLabelId(i_r163))("index", i_r163)("state", ctx_r160._getIndicatorType(i_r163, step_r162.state))("label", step_r162.stepLabel || step_r162.label)("selected", ctx_r160.selectedIndex === i_r163)("active", step_r162.completed || ctx_r160.selectedIndex === i_r163 || !ctx_r160.linear)("optional", step_r162.optional)("errorMessage", step_r162.errorMessage)("iconOverrides", ctx_r160._iconOverrides)("disableRipple", ctx_r160.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r163 + 1)("aria-setsize", ctx_r160.steps.length)("aria-controls", ctx_r160._getStepContentId(i_r163))("aria-selected", ctx_r160.selectedIndex == i_r163)("aria-label", step_r162.ariaLabel || null)("aria-labelledby", !step_r162.ariaLabel && step_r162.ariaLabelledby ? step_r162.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r164);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r172 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r172); const ctx_r171 = ɵngcc0.ɵɵnextContext(); return ctx_r171._animationDone.next($event); });
    ɵngcc0.ɵɵelementContainer(1, 8);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const step_r169 = ctx.$implicit;
    const i_r170 = ctx.index;
    const ctx_r161 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r161._getAnimationDirection(i_r170))("id", ctx_r161._getStepContentId(i_r170));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r161.selectedIndex === i_r170 ? 0 : null)("aria-labelledby", ctx_r161._getStepLabelId(i_r170))("aria-expanded", ctx_r161.selectedIndex === i_r170);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r169.content);
} }
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener() { const step_r174 = ctx.$implicit; return step_r174.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r179); const ctx_r178 = ɵngcc0.ɵɵnextContext(); return ctx_r178._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r179); const ctx_r180 = ɵngcc0.ɵɵnextContext(); return ctx_r180._animationDone.next($event); });
    ...
    const step_r174 = ctx.$implicit;
    const i_r175 = ctx.index;
    const isLast_r176 = ctx.last;
    const ctx_r173 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r173._getFocusIndex() == i_r175 ? 0 : 0 - 1)("id", ctx_r173._getStepLabelId(i_r175))("index", i_r175)("state", ctx_r173._getIndicatorType(i_r175, step_r174.state))("label", step_r174.stepLabel || step_r174.label)("selected", ctx_r173.selectedIndex === i_r175)("active", step_r174.completed || ctx_r173.selectedIndex === i_r175 || !ctx_r173.linear)("optional", step_r174.optional)("errorMessage", step_r174.errorMessage)("iconOverrides", ctx_r173._iconOverrides)("disableRipple", ctx_r173.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r175 + 1)("aria-setsize", ctx_r173.steps.length)("aria-controls", ctx_r173._getStepContentId(i_r175))("aria-selected", ctx_r173.selectedIndex === i_r175)("aria-label", step_r174.ariaLabel || null)("aria-labelledby", !step_r174.ariaLabel && step_r174.ariaLabelledby ? step_r174.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r176);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r173._getAnimationDirection(i_r175))("id", ctx_r173._getStepContentId(i_r175));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r173.selectedIndex === i_r175 ? 0 : null)("aria-labelledby", ctx_r173._getStepLabelId(i_r175))("aria-expanded", ctx_r173.selectedIndex === i_r175);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r174.content);
} }
